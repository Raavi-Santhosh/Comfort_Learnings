    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_link', models.CharField(blank=True, default='no-link', max_length=250, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
                ('video_uid', models.UUIDField(blank=True, default=uuid.uuid4, editable=False, null=True)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_content_videos', to='courses.courses')),
                ('course_heading', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_heading_videos', to='courses.coursecontentheadings')),
            ],
            options={
